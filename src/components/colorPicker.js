    ...
    <div className=" flex flex-col space-y-3">
      <div className="flex space-x-7">
        <div className="border p-0.5 rounded-md border-black">
          <div className="" style={styles.saturation}>
            <Saturation
              style={{
                circle: {
                  height: "8px",
        ...
        <div className="flex flex-col  w-full">
          <div className="border  border-black p-0.5 h-20 w-full rounded-md">
            <div
              style={{
          ...
          <div className="flex flex-col  mt-5 w-full">
            ...
            <div className="flex justify-center mt-2 hover:border-2 px-2   border border-gray-300 hover:border-black items-center h-9 rounded-md w-52">
              <div
                style={{
                  border: `5px solid rgba(${rgb.r},${rgb.g},${rgb.b},${rgb.a})`,
                  boxShadow: "0px 0px 0px rgba(0, 0, 0, 0.25)",
